...
const ERA_LOCATIONS: LocationInfo[] = [
  ...
  { id: 'sejera', name: 'Ilaniya', description: "A training farm founded in 1899 in the Lower Galilee. Its fields trained the guards of Bar Giora and Hashomer.", housing: 25, water: 30, health: 35, founded: 1899, type: 'training_farm' },
